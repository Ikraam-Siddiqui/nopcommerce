...
def pytest_configure(config):
    ...
    config.stash[metadata_key] ['Test Module Name'] = 'Admin Login Page'
    config.stash[metadata_key] ['Tester Name'] = 'Ikraam'
# Hook for delete/modify environments info in html reports
